...
class TestGetRecordingQueueDir:
    def test_returns_data_queues_subdir(self, tmp_path):
        ...
        with patch("src.recording.queue_paths.get_default_data_dir", return_value=fake_data_dir):
    ...
    def test_exemplar_data_dir_env_respected(self, tmp_path):
        ...
        with patch("src.recording.queue_paths.get_default_data_dir", return_value=custom_dir):
            result = get_recording_queue_dir()
...
class TestQueueFilePaths:
    def test_actions_queue_path_format(self, tmp_path):
        with patch("src.recording.queue_paths.get_default_data_dir", return_value=tmp_path / "data"):
