...
export function SkillPoolPanel({
  ...
  return (
    <section className="brain-skill-pool" aria-label="技能池">
      ...
      {loading ? <div className="brain-empty">正在加载技能池</div> : null}
      <div className="brain-skill-list">
        ...
        {!loading && filtered.length === 0 ? <div className="brain-empty">暂无匹配技能</div> : null}
      </div>
    </section>
  );
}
