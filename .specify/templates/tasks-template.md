...
- [ ] T005 [P] Define or extend shared cross-module events in src/utils/events.py
- [ ] T006 [P] Implement shared repositories/services required by all stories
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling, logging, and background execution boundaries
- [ ] T009 Setup configuration defaults, keyring integration, and example config updates
...
- [ ] TXXX Wiring smoke test and guard test updates for changed architecture paths
- [ ] TXXX Update active documentation in docs/ and contributor/agent guides
